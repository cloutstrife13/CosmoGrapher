    ...
    public class VertexTranslator
    {
        ...
        private static Dictionary<string, List<Property>> ConvertToGraphsonProperties(Object model)
        {
            ...
            foreach (var prop in properties)
            {
                ...
                if (prop.PropertyType.BaseType.Name != "Object" && prop.PropertyType.BaseType.Name != "ValueType") continue;
        ...
        private static Dictionary<string, List<Edge>> ConvertToGraphsonEdges(Object model)
        {
            ...
            foreach (var edge in edges)
            {
                ...
                if (edge.PropertyType.BaseType.Name == "Object" || edge.PropertyType.BaseType.Name == "ValueType" || edgeValue == null) continue;
